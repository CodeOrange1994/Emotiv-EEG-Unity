...
public class EmoEngine
{
    ...
    {
        EdkDll.Init();
        hEvent = EdkDll.Plugin_IEE_EmoEngineEventCreate();
    ...
    ~EmoEngine()
    {
        if (hEvent != IntPtr.Zero) EdkDll.Plugin_IEE_EmoEngineEventFree(hEvent);
    }
    ...
    public void ProcessEvents(Int32 maxTimeMilliseconds)
    {
        ...
        st.Start();
        while (EdkDll.Plugin_IEE_EngineGetNextEvent(hEvent) == EdkDll.EDK_OK)
        {
            ...
            UInt32 userId = 0;
            EdkDll.Plugin_IEE_EmoEngineEventGetUserId(hEvent, out userId);
            EmoEngineEventArgs args = new EmoEngineEventArgs(userId);
            EdkDll.IEE_Event_t eventType = EdkDll.Plugin_IEE_EmoEngineEventGetType(hEvent);
            switch (eventType)
            {
                ...
                case EdkDll.IEE_Event_t.IEE_EmoStateUpdated:
                    ...
                    errorHandler(EdkDll.Plugin_IEE_EmoEngineEventGetEmoState(hEvent, curEmoState.GetHandle()));
                ...
                case EdkDll.IEE_Event_t.IEE_MentalCommandEvent: 
                    EdkDll.IEE_MentalCommandEvent_t cogType = EdkDll.Plugin_IEE_MentalCommandEventGetType(hEvent);
                    switch(cogType){
                ...
                //    EdkDll.IEE_FacialExpressionEvent_t expEvent = EdkDll.Plugin_IEE_FacialExpressionEventGetType(hEvent);
                //    switch (expEvent)
                //    {
    ...
    public void Connect()
    {
        errorHandler(EdkDll.Plugin_IEE_EngineConnect("Emotiv Systems-5"));
    ...
    {
        errorHandler(EdkDll.Plugin_IEE_EngineRemoteConnect(ip, port));
        OnEmoEngineConnected(new EmoEngineEventArgs(UInt32.MaxValue));
    }
    ...
    {
        errorHandler(EdkDll.Plugin_IEE_EngineDisconnect());
    ...
    //{
    //    UInt32 numUser = 0;
    //    errorHandler(EdkDll.Plugin_IEE_EngineGetNumUser(out numUser));
    //    return numUser;
    //}
    ...
    //{
    //    errorHandler(EdkDll.Plugin_IEE_SetHardwarePlayerDisplay(userId, playerNum));
    //}
    ...
    //{
    //    errorHandler(EdkDll.Plugin_IEE_FacialExpressionSetThreshold(userId, algoName, thresholdName, value));
    //}
    ...
    //{
    //    Int32 valueOut = 0;
    //    errorHandler(EdkDll.Plugin_IEE_FacialExpressionGetThreshold(userId, algoName, thresholdName, out valueOut));
    //    return valueOut;
    //}
    ...
    //{
    //    errorHandler(EdkDll.Plugin_IEE_FacialExpressionSetTrainingAction(userId, action));
    //}
    ...
    //{
    //    errorHandler(EdkDll.Plugin_IEE_FacialExpressionSetTrainingControl(userId, control));
    //}
    ...
    //    errorHandler(EdkDll.Plugin_IEE_FacialExpressionGetTrainingAction(userId, out actionOut));
    //    return actionOut;
    //}
    ...
    //    errorHandler(EdkDll.Plugin_IEE_FacialExpressionGetTrainingTime(userId, out trainingTimeOut));
    ...
    //    errorHandler(EdkDll.Plugin_IEE_FacialExpressionGetTrainedSignatureActions(userId, out trainedActionsOut));
    ...
    //    errorHandler(EdkDll.Plugin_IEE_FacialExpressionGetTrainedSignatureAvailable(userId, out availableOut));
    //    return availableOut;
    //}
    ...
    //{
    //    errorHandler(EdkDll.Plugin_IEE_FacialExpressionSetSignatureType(userId, sigType));
    //}
    ...
    //    errorHandler(EdkDll.Plugin_IEE_FacialExpressionGetSignatureType(userId, out sigTypeOut));
    //    return sigTypeOut;
    //}
    ...
    {
        errorHandler(EdkDll.Plugin_IEE_MentalCommandSetActiveActions(userId, activeActions));
    }
    ...
    public UInt32 MentalCommandGetActiveActions(UInt32 userId)
    {
        ...
        errorHandler(EdkDll.Plugin_IEE_MentalCommandGetActiveActions(userId, out activeActionsOut));
    ...
    //{
    //    UInt32 trainingTimeOut = 0;
    //    errorHandler(EdkDll.Plugin_IEE_MentalCommandGetTrainingTime(userId, out trainingTimeOut));
    //    return trainingTimeOut;
    //}
    ...
    {
        errorHandler(EdkDll.Plugin_IEE_MentalCommandSetTrainingControl(userId, control));
    }
    ...
    {
        errorHandler(EdkDll.Plugin_IEE_MentalCommandSetTrainingAction(userId, action));
    }
    ...
    //    errorHandler(EdkDll.Plugin_IEE_MentalCommandGetTrainingAction(userId, out actionOut));
    //    return actionOut;
    //}
    ...
    //{
    //    UInt32 trainedActionsOut = 0;
    //    errorHandler(EdkDll.Plugin_IEE_MentalCommandGetTrainedSignatureActions(userId, out trainedActionsOut));
    //    return trainedActionsOut;
    //}
    ...
    //    errorHandler(EdkDll.Plugin_IEE_MentalCommandGetOverallSkillRating(userId, out overallSkillRatingOut));
    ...
    //    errorHandler(EdkDll.Plugin_IEE_MentalCommandGetActionSkillRating(userId, action, out actionSkillRatingOut));
    ...
    //{
    //    errorHandler(EdkDll.Plugin_IEE_MentalCommandSetActivationLevel(userId, level));
    //}
    ...
    //{
    //    errorHandler(EdkDll.Plugin_IEE_MentalCommandSetActionSensitivity(userId, action1Sensitivity, action2Sensitivity, action3Sensitivity, action4Sensitivity));
    //}
    ...
    //{
    //    Int32 levelOut = 0;
    //    errorHandler(EdkDll.Plugin_IEE_MentalCommandGetActivationLevel(userId, out levelOut));
    //    return levelOut;
    //}
    ...
    //{
    //    errorHandler(EdkDll.Plugin_IEE_MentalCommandGetActionSensitivity(userId, out pAction1SensitivityOut, out pAction2SensitivityOut,
    ...
    //{
    //    errorHandler(EdkDll.Plugin_IEE_MentalCommandStartSamplingNeutral(userId));
    //}
    ...
    //{
    //    errorHandler(EdkDll.Plugin_IEE_MentalCommandStopSamplingNeutral(userId));
    //}
    ...
    //{
    //    errorHandler(EdkDll.Plugin_IEE_MentalCommandSetSignatureCaching(userId, enabled));
    //}
    ...
    //{
    //    UInt32 enabledOut = 0;
    //    errorHandler(EdkDll.Plugin_IEE_MentalCommandGetSignatureCaching(userId, out enabledOut));
    //    return enabledOut;
    //}
    ...
    //{
    //    errorHandler(EdkDll.Plugin_IEE_MentalCommandSetSignatureCacheSize(userId, size));
    //}
    ...
    //{
    //    UInt32 sizeOut = 0;
    //    errorHandler(EdkDll.Plugin_IEE_MentalCommandGetSignatureCacheSize(userId, out sizeOut));
    //    return sizeOut;
    //}
    ...
    //    errorHandler(EdkDll.Plugin_IEE_HeadsetGetSensorDetails(channelId, out descriptorOut));
    ...
    //{
    //    UInt32 hwVersionOut;
    //    errorHandler(EdkDll.Plugin_IEE_HardwareGetVersion(userId, out hwVersionOut));
    //    return hwVersionOut;
    //}
    ...
    //    errorHandler(EdkDll.Plugin_IEE_SoftwareGetVersion(version,(UInt32) version.Capacity, out pBuildNumOut));
    ...
    //{
    //    errorHandler(EdkDll.Plugin_IEE_HeadsetGetGyroDelta(userId, out pXOut, out pYOut));
    //}
    ...
    //{
    //    errorHandler(EdkDll.Plugin_IEE_HeadsetGyroRezero(userId));
    //}
    ...
    //{
    //    errorHandler(EdkDll.Plugin_IEE_MotionDataSetBufferSizeInSec(bufferSizeInSec));
    //}
    ...
    //    errorHandler(EdkDll.Plugin_IEE_MotionDataGetBufferSizeInSec(out bufferSizeInSecOut));
    ...
    //    //errorHandler(EdkDll.Plugin_IEE_MotionDataUpdateHandle(userId, hMotionData));
    //    EdkDll.Plugin_IEE_MotionDataUpdateHandle(userId, hMotionData);

    //    UInt32 nSample = 10;
    //    errorHandler(EdkDll.Plugin_IEE_MotionDataGetNumberOfSample(hMotionData, out nSample));
    ...
    //        errorHandler(EdkDll.Plugin_IEE_MotionDataGet(hMotionData, channel, result[channel], nSample));
    //    }
    ...
    //    errorHandler(EdkDll.Plugin_IEE_MotionDataGetSamplingRate(userId, out samplingRate));
    //    return samplingRate;
    //}
}